...
ARCHITECTURE TB OF TB_RGB_CONTROLADOR IS
	...
	-- DECLARACIÓN DEL COMPONENTE (ACTUALIZADO AL NUEVO DISEÑO)
	COMPONENT RGB_CONTROLADOR
		PORT (
			CLK_RGB : IN  STD_LOGIC;
			RST_RGB : IN  STD_LOGIC;
			-- DESDOBALMOS LOS BOTONES
	...
	SIGNAL BTN_UP_STATE   : STD_LOGIC := '0';
	SIGNAL BTN_DOWN_PULSE : STD_LOGIC := '0';
	SIGNAL BTN_DOWN_STATE : STD_LOGIC := '0';
	...
	SIGNAL ROJO_OUT : STD_LOGIC_VECTOR(7 DOWNTO 0);
	SIGNAL VERDE_OUT : STD_LOGIC_VECTOR(7 DOWNTO 0);
	SIGNAL AZUL_OUT : STD_LOGIC_VECTOR(7 DOWNTO 0);
...
BEGIN
	...
	PORT MAP (
		...
		BTN_UP_STATE => BTN_UP_STATE,     -- Conectamos aunque dejemos a '0'
		BTN_DOWN_PULSE => BTN_DOWN_PULSE,
		BTN_DOWN_STATE => BTN_DOWN_STATE, -- Conectamos aunque dejemos a '0'
		SW_RGB => SW_RGB,
	...
	BEGIN
		...
		-- NOTA: Como en esta prueba solo queremos ver que suma 1 a 1,
		-- usaremos la señal _PULSE. La señal _STATE la dejamos a '0'.

		-- 1. SUBIDAS:
		-- ROJO A 3
		SW_RGB <= ROJO_SW;
		FOR I IN 1 TO 3 LOOP
			BTN_UP_PULSE <= '1'; -- Simulamos un clic rápido
			WAIT FOR TBPERIOD;
			BTN_UP_PULSE <= '0';
			WAIT FOR TBPERIOD;
		END LOOP;
		...
		-- INTENTAMOS BAJAR 5 VECES MÁS USANDO PULSE
		FOR I IN 1 TO 5 LOOP
			...
			WAIT FOR TBPERIOD;
		END LOOP;
		-- ROJO_OUT DEBE SEGUIR SIENDO "00000000"
